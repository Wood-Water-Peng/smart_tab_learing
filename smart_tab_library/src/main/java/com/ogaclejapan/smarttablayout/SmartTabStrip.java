...
class SmartTabStrip extends LinearLayout {
    ...
    private static final String TAG = "SmartTabStrip";
    ...
    private void drawDecoration(Canvas canvas) {
        ...
        if (tabCount > 0) {
            ...
            if (selectionOffset > 0f && selectedPosition < (getChildCount() - 1)) {
                ...
                Log.i(TAG, "endOffset:" + endOffset + "-nextEnd:" + nextEnd + "-left:" + left);
                Log.i(TAG, "startOffset:" + startOffset + "-nextStart:" + nextStart + "-right:" + right);
                /**
                 * startOffset: 0-1
                 * endOffset: 0-1
                 */
